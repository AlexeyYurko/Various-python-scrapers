...
cur.execute('''SELECT * FROM cities WHERE scraped=0''')
towns = cur.fetchall()
...
driver.find_element_by_xpath(
    "//select[@id='body_umbBodyContent_BranchSearch_1_ddlRadius']/option[@value='20']").click()
...
for town in towns:
    ...
    cur.execute(
        '''UPDATE cities SET scraped = 1 WHERE City = ?''', (town[0],))
    conn.commit()
